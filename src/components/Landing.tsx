          ...
          <div id="projectsContainer">
            ...
            <div>
              ...
              <p className="subAbout">
                ...
                implement web sockets for communication. Server built with
                NestJS using passport for authentication with Google. Client
                created using React with TypeScript. MongoDB is used to track
            ...
            <div>
              ...
              <p className="subScript">
                AWS Lambda, DynamoDB, API Gateway, SAM
              </p>
              <p className="subAbout">
                Implemented a simple authentication API that supports sign ups,
                logins, and session caching through bearer tokens.
                Infrastructure is defined using AWS SAM, all storage is done in
                DynamoDB, and all API calls are handled with Lambda.
              </p>
            </div>
